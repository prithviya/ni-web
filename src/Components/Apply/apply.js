                                    ...
                                    <div className="uk-position-bottom-right uk-overlay">
                                        <div className="uk-clearfix">
                                            <div className="uk-float-right">
                                                <div className="uk-card text-white custom-text-bg">Our Story</div>
                                            </div>
                                        </div>                        
                                    </div>
                                </div>    
                            ...
                            <a href="#">
                                ...
                                <img src={Images.STORYLOGO} alt='story_logo'/>
                                    <div className="uk-position-bottom-right uk-overlay">
                                        <div className="uk-clearfix">
                                            <div className="uk-float-right">
                                                <div className="uk-card text-white custom-text-bg">Story of Our Logo</div>
                                            </div>
                                        </div>                        
                                    </div>
                                </div> 
                            ...
                            <a href="#">
                                <div className="uk-inline custom-sect-bg uk-float-left">
                                    ...
                                    <div className="uk-position-bottom-right uk-overlay">
                                        <div className="uk-clearfix">
                                            <div className="uk-float-right">
                                                <div className="uk-card text-white custom-text-bg">Leadership Team</div>
                                            </div>
                                        </div>                        
                                    </div>
                                </div>     
                ...
                <div className="">
                    ...
                    <ul id="component-nav" className="uk-switcher">
                        ...
                        <li>
                            <div className="uk-padding-small">
                                <h3 className="text-blue" style={{fontSize:'1rem'}}>
                                Raajarajan V P – Chief Executive Officer, Dr Vanikala - Senior VP & Head – Global Delivery, Chitra K – Senior VP & Head - HR Operations.
                                </h3> 
                                <p className="text-black uk-text-justify" style={{fontSize:'0.75rem'}}>
